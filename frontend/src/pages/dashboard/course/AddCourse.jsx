...
const AddCourse = () => {
  ...
  <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
    ...
    <div className="px-4 pt-8 mt-10 bg-gray-50 lg:mt-0">
      ...
      <div className="">
        <label for="email" className="block mt-4 mb-2 text-sm font-medium">Email</label>
        <div className="relative">
        ...
        <label for="card-holder" className="block mt-4 mb-2 text-sm font-medium">Card Holder</label>
        <div className="relative">
        ...
        <label for="card-no" className="block mt-4 mb-2 text-sm font-medium">Card Details</label>
        <div className="flex">
        ...
        <label for="billing-address" className="block mt-4 mb-2 text-sm font-medium">Billing Address</label>
