...
const AddCourse = () => {
  ...
  <>
    ...
    <a href="#" className="text-2xl font-bold text-gray-800">Add Course</a>
  ...
  <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
    <div className="px-4 pt-8">
      <p className="text-xl font-medium">Course Chapter</p>
      ...
      <div className="px-2 py-4 mt-8 space-y-3 bg-white border rounded-lg sm:px-6">
        <div className="flex flex-col bg-white rounded-lg sm:flex-row">
          ...
          <div className="flex flex-col w-full px-4 py-4">
            <span className="font-semibold">Intro to React</span>
        ...
        <div className="flex flex-col bg-white rounded-lg sm:flex-row">
          ...
          <div className="flex flex-col w-full px-4 py-4">
            <span className="font-semibold">Why React ? </span>
            {/* <span className="float-right text-gray-400">42EU - 8.5US</span> */}
            {/* <p className="mt-auto text-lg font-bold">unpublished</p> */}
          </div>
        </div>
      </div>
  
      <p className="mt-8 text-lg font-medium">Course Visibility</p>
      <form className="grid gap-6 mt-5">
        <div className="relative">
          ...
          <label className="flex p-4 border border-gray-300 rounded-lg cursor-pointer select-none peer-checked:border-2 peer-checked:border-gray-700 peer-checked:bg-gray-50" for="radio_1">
            <img className="object-contain w-14" src="/images/naorrAeygcJzX0SyNI4Y0.png" alt="" />
            <div className="ml-5">
              <span className="mt-2 font-semibold">Public</span>
        ...
        <div className="relative">
          ...
          <span className="box-content absolute block w-3 h-3 -translate-y-1/2 bg-white border-8 border-gray-300 rounded-full peer-checked:border-gray-700 right-4 top-1/2"></span>
          <label className="flex p-4 border border-gray-300 rounded-lg cursor-pointer select-none peer-checked:border-2 peer-checked:border-gray-700 peer-checked:bg-gray-50" for="radio_2">
            <img className="object-contain w-14" src="/images/oG8xsl3xsOkwkMsrLGKM4.png" alt="" />
            <div className="ml-5">
              <span className="mt-2 font-semibold">Private</span>
              {/* <p className="text-sm leading-6 text-slate-500">Delivery: 2-4 Days</p> */}
            </div>
          </label>
        </div>
    ...
    <div className="px-4 pt-8 mt-10 bg-gray-50 lg:mt-0">
      ...
      <div className="">
        <label for="email" className="block mt-4 mb-2 text-sm font-medium">Course Title</label>
        <div className="relative">
          <input type="text" id="email" name="email" className="w-full px-4 py-3 text-sm border border-gray-200 rounded-md shadow-sm outline-none pl-11 focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="React Js course" />
        ...
        <label for="card-holder" className="block mt-4 mb-2 text-sm font-medium">Course Description</label>
        <div className="relative">
          <input type="text" id="card-holder" name="card-holder" className="w-full px-4 py-3 text-sm uppercase border border-gray-200 rounded-md shadow-sm outline-none pl-11 focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="Description here" />
          <div className="absolute inset-y-0 left-0 inline-flex items-center px-3 pointer-events-none">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        ...
        <label for="card-no" className="block mt-4 mb-2 text-sm font-medium">Course Category</label>
        <div className="flex">
          <div className="relative flex-shrink-0 w-7/12">
            <input type="text" id="card-no" name="card-no" className="w-full px-2 py-3 text-sm border border-gray-200 rounded-md shadow-sm outline-none pl-11 focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="Frontend" />
            <div className="absolute inset-y-0 left-0 inline-flex items-center px-3 pointer-events-none">
          ...
          <input type="text" name="credit-expiry" className="w-full px-2 py-3 text-sm border border-gray-200 rounded-md shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="Price" />
        ...
        <label for="billing-address" className="block mt-4 mb-2 text-sm font-medium">Course Video</label>
        <div className="flex flex-col sm:flex-row">
          <div className="relative flex-shrink-0 sm:w-7/12">
            <input type="file" id="billing-address" name="billing-address" className="w-full px-4 py-3 text-sm border border-gray-200 rounded-md shadow-sm outline-none pl-11 focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="Upload Video" />
            {/* <div className="absolute inset-y-0 left-0 inline-flex items-center px-3 pointer-events-none">
              <img className="object-contain w-4 h-4" src="https://flagpack.xyz/_nuxt/4c829b6c0131de7162790d2f897a90fd.svg" alt="" />
            </div> */}
          </div>
          {/* <select type="text" name="billing-state" className="w-full px-4 py-3 text-sm border border-gray-200 rounded-md shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500">
        ...
        <div className="py-2 mt-6 border-t border-b">
          ...
          <div className="flex items-center justify-between">
            <p className="text-sm font-medium text-gray-900">Certification Fee</p>
